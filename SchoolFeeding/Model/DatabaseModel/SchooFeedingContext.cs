...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=C:\\USERS\\ARTEM\\DESKTOP\\DEKKI\\SCHOOLFEEDING\\BIN\\DEBUG\\NET7.0-WINDOWS\\DATA\\SCHOOLFEEDING.MDF;Trusted_Connection=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Visit__32C52A79B7CBCC5A");
            ...
            entity.HasOne(d => d.Student).WithOne(p => p.Visit)
                .HasForeignKey<Visit>(d => d.StudentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Visit__StudentID__160F4887");
        });
